-- Fix the update_seller_order_status function to remove invalid metadata column from notifications table
...
BEGIN
  ...
  ELSIF p_action = 'pack' THEN
    ...
    -- Also create agent_notifications for real-time updates (this table HAS metadata column)
