-- Drop and recreate the get_products_within_range function to fix stock calculation
DROP FUNCTION IF EXISTS get_products_within_range(double precision, double precision, double precision);
